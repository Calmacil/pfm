...
<div id="menu">
	<ul>
		...
		<li>
			<a id="mop" href="">Opportunit&eacute;s</a>
		</li>
		<li>
			<a id="mcli" href="javascript:toggle('agenda')">Agenda</a>
			<div id="agenda" class="smen" style="display: none">
				<?php
					$this->url('RDVs &agrave; venir');
					$this->url('Nouveau RDV');
				?>
			</div>
		</li>
	</ul>
